public class mein {
    ...
    public static void main(String[] args) {
        ...
        prenotazioneG pg2 = new prenotazioneG(Sala.INTERNO,3,2);

        prenotazioneG pg1 = new prenotazioneG(Sala.ESTERNO,2,1);
        System.out.println(mgp1.Prenota(p1=new PrenotazioneSingola(Sala.INTERNO,3)));
        System.out.println(mgp1.salae.getPosti());
